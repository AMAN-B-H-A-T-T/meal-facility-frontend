          ...
          <div className="flex flex-1 items-center justify-center lg:items-stretch lg:justify-between">
            <div className="flex flex-shrink-0 items-center">
              ...
              >
                <img
                  ...
                  decoding="async"
                  data-nimg={1}
                  className="h-auto w-16 mix-blend-darken mr-2"
            ...
            <div className="hidden lg:ml-6 lg:flex items-center">
              <div className="flex space-x-4">
                <button
                  className={`text-zinc-950 ${selectedScreen == 'calender' ? 'underline decoration-violet-500	decoration-solid decoration-4' :null } rounded-md px-3 py-2 text-sm font-medium`}
                  onClick={() => {onSelectScreen('calender')}}
                >
                  Calender
                </button>
                <button
                  className={`text-zinc-950 ${selectedScreen == 'booking-list' ? 'underline decoration-violet-500	decoration-solid decoration-4' :null } rounded-md px-3 py-2 text-sm font-medium`}
              ...
              <div className="flex space-x-4">
                ...
                <div className="flex items-center relative">
                  <svg
                    ...
                    height={20}
                    fill="currentColor"
                    className="sm:ml-10 bi bi-person-circle cursor-pointer"
                    viewBox="0 0 16 16"
                  ...
                  <div
                    id="dropdown"
                    className={`${profileDropdown?'':'hidden'} z-10 absolute top-8 left-8 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}
                  >
                    <ul
